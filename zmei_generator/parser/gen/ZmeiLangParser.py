...
class ZmeiLangParser ( Parser ):
    ...
    RULE_an_crud_link_suffix = 182
    RULE_an_crud_link_suffix_val = 183
    ...
    def an_crud_link_suffix(self):
        ...
        self.enterRule(localctx, 364, self.RULE_an_crud_link_suffix)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1625
    ...
    def an_crud_link_suffix_val(self):
        ...
        self.enterRule(localctx, 366, self.RULE_an_crud_link_suffix_val)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 1629
