...
Unicode_Letter: [a-zA-Z0-9]
   |Unicode_Lowercase_Letter
   |Unicode_Uppercase_Letter
   |Unicode_Decimal_Number
   ;
Unicode_Error:      CLASSIFY___;
Unicode_Control:      CLASSIFY_Cc;
Unicode_Format:      CLASSIFY_Cf;
Unicode_Unassigned:      CLASSIFY_Cn;
Unicode_Private_Use:      CLASSIFY_Co;
Unicode_Surrogate:      CLASSIFY_Cs;
Unicode_Lowercase_Letter:      CLASSIFY_Ll;
Unicode_Modifier_Letter:      CLASSIFY_Lm;
Unicode_Other_Letter:      CLASSIFY_Lo;
Unicode_Titlecase_Letter:      CLASSIFY_Lt;
Unicode_Uppercase_Letter:      CLASSIFY_Lu;
Unicode_Spacing_Mark:      CLASSIFY_Mc;
Unicode_Enclosing_Mark:      CLASSIFY_Me;
Unicode_Nonspacing_Mark:      CLASSIFY_Mn;
Unicode_Decimal_Number:      CLASSIFY_Nd;
Unicode_Letter_Number:      CLASSIFY_Nl;
Unicode_Other_Number:      CLASSIFY_No;
Unicode_Connector_Punctuation:      CLASSIFY_Pc;
Unicode_Dash_Punctuation:      CLASSIFY_Pd;
Unicode_Close_Punctuation:      CLASSIFY_Pe;
Unicode_Final_Punctuation:      CLASSIFY_Pf;
Unicode_Initial_Punctuation:      CLASSIFY_Pi;
Unicode_Other_Punctuation:      CLASSIFY_Po;
Unicode_Open_Punctuation:      CLASSIFY_Ps;
Unicode_Currency_Symbol:      CLASSIFY_Sc;
Unicode_Modifier_Symbol:      CLASSIFY_Sk;
Unicode_Math_Symbol:      CLASSIFY_Sm;
Unicode_Other_Symbol:      CLASSIFY_So;
Unicode_Line_Separator:      CLASSIFY_Zl;
Unicode_Paragraph_Separator:      CLASSIFY_Zp;
Unicode_Space_Separator:      CLASSIFY_Zs;
